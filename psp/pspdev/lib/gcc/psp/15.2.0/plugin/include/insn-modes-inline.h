...
mode_size_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case E_CCDSPmode: return 4;
    case E_CCEmode: return 4;
    case E_CCFmode: return 4;
...
mode_nunits_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case E_CCV2mode: return 1;
    case E_CCV4mode: return 1;
    case E_CCDSPmode: return 1;
    case E_CCEmode: return 1;
    case E_CCFmode: return 1;
    case E_BImode: return 1;
    case E_QImode: return 1;
...
mode_inner_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case E_CCV2mode: return E_CCV2mode;
    case E_CCV4mode: return E_CCV4mode;
    case E_CCDSPmode: return E_CCDSPmode;
    case E_CCEmode: return E_CCEmode;
    case E_CCFmode: return E_CCFmode;
...
mode_unit_precision_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case E_CCV2mode: return 4*BITS_PER_UNIT;
    case E_CCV4mode: return 4*BITS_PER_UNIT;
    case E_CCDSPmode: return 4*BITS_PER_UNIT;
    case E_CCEmode: return 4*BITS_PER_UNIT;
    case E_CCFmode: return 4*BITS_PER_UNIT;
    case E_BImode: return 1;
