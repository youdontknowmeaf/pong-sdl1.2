...
#define HAVE_sunordered_sf_using_cce (((!ISA_HAS_CCF) && (TARGET_HARD_FLOAT)) && (TARGET_HARD_FLOAT))
#define HAVE_suneq_sf_using_cce (((!ISA_HAS_CCF) && (TARGET_HARD_FLOAT)) && (TARGET_HARD_FLOAT))
#define HAVE_sunlt_sf_using_cce (((!ISA_HAS_CCF) && (TARGET_HARD_FLOAT)) && (TARGET_HARD_FLOAT))
#define HAVE_sunle_sf_using_cce (((!ISA_HAS_CCF) && (TARGET_HARD_FLOAT)) && (TARGET_HARD_FLOAT))
#define HAVE_seq_sf_using_cce (((!ISA_HAS_CCF) && (TARGET_HARD_FLOAT)) && (TARGET_HARD_FLOAT))
#define HAVE_slt_sf_using_cce (((!ISA_HAS_CCF) && (TARGET_HARD_FLOAT)) && (TARGET_HARD_FLOAT))
#define HAVE_sle_sf_using_cce (((!ISA_HAS_CCF) && (TARGET_HARD_FLOAT)) && (TARGET_HARD_FLOAT))
#define HAVE_sunordered_df_using_cce (((!ISA_HAS_CCF) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT)) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
#define HAVE_suneq_df_using_cce (((!ISA_HAS_CCF) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT)) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
#define HAVE_sunlt_df_using_cce (((!ISA_HAS_CCF) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT)) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
#define HAVE_sunle_df_using_cce (((!ISA_HAS_CCF) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT)) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
#define HAVE_seq_df_using_cce (((!ISA_HAS_CCF) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT)) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
#define HAVE_slt_df_using_cce (((!ISA_HAS_CCF) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT)) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
#define HAVE_sle_df_using_cce (((!ISA_HAS_CCF) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT)) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
...
#define HAVE_sge_sf_using_cce (((!ISA_HAS_CCF) && (TARGET_HARD_FLOAT)) && (TARGET_HARD_FLOAT))
#define HAVE_sgt_sf_using_cce (((!ISA_HAS_CCF) && (TARGET_HARD_FLOAT)) && (TARGET_HARD_FLOAT))
#define HAVE_sunge_sf_using_cce (((!ISA_HAS_CCF) && (TARGET_HARD_FLOAT)) && (TARGET_HARD_FLOAT))
#define HAVE_sungt_sf_using_cce (((!ISA_HAS_CCF) && (TARGET_HARD_FLOAT)) && (TARGET_HARD_FLOAT))
#define HAVE_sge_df_using_cce (((!ISA_HAS_CCF) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT)) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
#define HAVE_sgt_df_using_cce (((!ISA_HAS_CCF) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT)) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
#define HAVE_sunge_df_using_cce (((!ISA_HAS_CCF) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT)) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
#define HAVE_sungt_df_using_cce (((!ISA_HAS_CCF) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT)) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
...
#define HAVE_movsi_on_si (!TARGET_MIPS16 && ISA_HAS_CONDMOVE)
#define HAVE_movdi_on_si ((!TARGET_MIPS16 && ISA_HAS_CONDMOVE) && (TARGET_64BIT))
#define HAVE_movsi_on_di ((!TARGET_MIPS16 && ISA_HAS_CONDMOVE) && (TARGET_64BIT))
#define HAVE_movdi_on_di ((!TARGET_MIPS16 && ISA_HAS_CONDMOVE) && (TARGET_64BIT))
#define HAVE_movsi_on_cc ((!TARGET_MIPS16 && ISA_HAS_CONDMOVE) && (TARGET_HARD_FLOAT \
				   && !TARGET_LOONGSON_2EF \
				   && !TARGET_MIPS5900 \
				   && !TARGET_ALLEGREX))
#define HAVE_movdi_on_cc ((!TARGET_MIPS16 && ISA_HAS_CONDMOVE) && ((((TARGET_64BIT) && (TARGET_HARD_FLOAT \
				   && !TARGET_LOONGSON_2EF \
				   && !TARGET_MIPS5900 \
				   && !TARGET_ALLEGREX)) && (TARGET_64BIT)) && (TARGET_64BIT)))
#define HAVE_movsi_on_cce ((!TARGET_MIPS16 && ISA_HAS_CONDMOVE) && (TARGET_HARD_FLOAT \
				   && !TARGET_LOONGSON_2EF \
				   && !TARGET_MIPS5900 \
				   && !TARGET_ALLEGREX))
#define HAVE_movdi_on_cce ((!TARGET_MIPS16 && ISA_HAS_CONDMOVE) && ((((TARGET_64BIT) && (TARGET_HARD_FLOAT \
				   && !TARGET_LOONGSON_2EF \
				   && !TARGET_MIPS5900 \
				   && !TARGET_ALLEGREX)) && (TARGET_64BIT)) && (TARGET_64BIT)))
#define HAVE_movsi_on_si_mips16e2 (ISA_HAS_MIPS16E2 && ISA_HAS_CONDMOVE)
#define HAVE_movdi_on_si_mips16e2 ((ISA_HAS_MIPS16E2 && ISA_HAS_CONDMOVE) && (TARGET_64BIT))
#define HAVE_movsi_on_di_mips16e2 ((ISA_HAS_MIPS16E2 && ISA_HAS_CONDMOVE) && (TARGET_64BIT))
#define HAVE_movdi_on_di_mips16e2 ((ISA_HAS_MIPS16E2 && ISA_HAS_CONDMOVE) && (TARGET_64BIT))
#define HAVE_movsi_on_cc_mips16e2 ((ISA_HAS_MIPS16E2 && ISA_HAS_CONDMOVE) && (TARGET_HARD_FLOAT \
				   && !TARGET_LOONGSON_2EF \
				   && !TARGET_MIPS5900 \
				   && !TARGET_ALLEGREX))
#define HAVE_movdi_on_cc_mips16e2 ((ISA_HAS_MIPS16E2 && ISA_HAS_CONDMOVE) && ((((TARGET_64BIT) && (TARGET_HARD_FLOAT \
				   && !TARGET_LOONGSON_2EF \
				   && !TARGET_MIPS5900 \
				   && !TARGET_ALLEGREX)) && (TARGET_64BIT)) && (TARGET_64BIT)))
#define HAVE_movsi_on_cce_mips16e2 ((ISA_HAS_MIPS16E2 && ISA_HAS_CONDMOVE) && (TARGET_HARD_FLOAT \
				   && !TARGET_LOONGSON_2EF \
				   && !TARGET_MIPS5900 \
				   && !TARGET_ALLEGREX))
#define HAVE_movdi_on_cce_mips16e2 ((ISA_HAS_MIPS16E2 && ISA_HAS_CONDMOVE) && ((((TARGET_64BIT) && (TARGET_HARD_FLOAT \
				   && !TARGET_LOONGSON_2EF \
				   && !TARGET_MIPS5900 \
				   && !TARGET_ALLEGREX)) && (TARGET_64BIT)) && (TARGET_64BIT)))
#define HAVE_movsi_on_si_ne (!TARGET_MIPS16 && ISA_HAS_CONDMOVE)
#define HAVE_movdi_on_si_ne ((!TARGET_MIPS16 && ISA_HAS_CONDMOVE) && (TARGET_64BIT))
#define HAVE_movsi_on_di_ne ((!TARGET_MIPS16 && ISA_HAS_CONDMOVE) && (TARGET_64BIT))
#define HAVE_movdi_on_di_ne ((!TARGET_MIPS16 && ISA_HAS_CONDMOVE) && (TARGET_64BIT))
#define HAVE_movsi_on_si_ne_mips16e2 (ISA_HAS_MIPS16E2 && ISA_HAS_CONDMOVE)
#define HAVE_movdi_on_si_ne_mips16e2 ((ISA_HAS_MIPS16E2 && ISA_HAS_CONDMOVE) && (TARGET_64BIT))
#define HAVE_movsi_on_di_ne_mips16e2 ((ISA_HAS_MIPS16E2 && ISA_HAS_CONDMOVE) && (TARGET_64BIT))
#define HAVE_movdi_on_di_ne_mips16e2 ((ISA_HAS_MIPS16E2 && ISA_HAS_CONDMOVE) && (TARGET_64BIT))
...
#define HAVE_sminsf3 ((ISA_HAS_FMIN_FMAX) && (TARGET_HARD_FLOAT))
#define HAVE_smindf3 ((ISA_HAS_FMIN_FMAX) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
#define HAVE_smaxsf3 ((ISA_HAS_FMIN_FMAX) && (TARGET_HARD_FLOAT))
#define HAVE_smaxdf3 ((ISA_HAS_FMIN_FMAX) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
#define HAVE_fminsf3 ((ISA_HAS_FMIN_FMAX) && (TARGET_HARD_FLOAT))
#define HAVE_fmindf3 ((ISA_HAS_FMIN_FMAX) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
#define HAVE_fmaxsf3 ((ISA_HAS_FMIN_FMAX) && (TARGET_HARD_FLOAT))
#define HAVE_fmaxdf3 ((ISA_HAS_FMIN_FMAX) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
#define HAVE_fmin_a_sf ((ISA_HAS_FMIN_FMAX) && (TARGET_HARD_FLOAT))
#define HAVE_fmin_a_df ((ISA_HAS_FMIN_FMAX) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
#define HAVE_fmax_a_sf ((ISA_HAS_FMIN_FMAX) && (TARGET_HARD_FLOAT))
#define HAVE_fmax_a_df ((ISA_HAS_FMIN_FMAX) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
#define HAVE_rintsf2 ((ISA_HAS_FRINT) && (TARGET_HARD_FLOAT))
#define HAVE_rintdf2 ((ISA_HAS_FRINT) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
#define HAVE_fclass_sf ((ISA_HAS_FCLASS) && (TARGET_HARD_FLOAT))
#define HAVE_fclass_df ((ISA_HAS_FCLASS) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
...
#define HAVE_msa_shf_d_f (ISA_HAS_MSA)
...
#define HAVE_sdot_prodv2siv4hi (TARGET_HARD_FLOAT && TARGET_LOONGSON_MMI)
...
#define HAVE_reduc_smin_scal_v2df (ISA_HAS_MSA)
#define HAVE_reduc_smin_scal_v4sf (ISA_HAS_MSA)
#define HAVE_reduc_smin_scal_v2di (ISA_HAS_MSA)
#define HAVE_reduc_smin_scal_v4si (ISA_HAS_MSA)
#define HAVE_reduc_smin_scal_v8hi (ISA_HAS_MSA)
#define HAVE_reduc_smin_scal_v16qi (ISA_HAS_MSA)
#define HAVE_reduc_smax_scal_v2df (ISA_HAS_MSA)
#define HAVE_reduc_smax_scal_v4sf (ISA_HAS_MSA)
#define HAVE_reduc_smax_scal_v2di (ISA_HAS_MSA)
#define HAVE_reduc_smax_scal_v4si (ISA_HAS_MSA)
#define HAVE_reduc_smax_scal_v8hi (ISA_HAS_MSA)
#define HAVE_reduc_smax_scal_v16qi (ISA_HAS_MSA)
#define HAVE_reduc_umin_scal_v2di (ISA_HAS_MSA)
#define HAVE_reduc_umin_scal_v4si (ISA_HAS_MSA)
#define HAVE_reduc_umin_scal_v8hi (ISA_HAS_MSA)
#define HAVE_reduc_umin_scal_v16qi (ISA_HAS_MSA)
#define HAVE_reduc_umax_scal_v2di (ISA_HAS_MSA)
#define HAVE_reduc_umax_scal_v4si (ISA_HAS_MSA)
#define HAVE_reduc_umax_scal_v8hi (ISA_HAS_MSA)
#define HAVE_reduc_umax_scal_v16qi (ISA_HAS_MSA)
#define HAVE_reduc_plus_scal_v2df (ISA_HAS_MSA)
#define HAVE_reduc_plus_scal_v4sf (ISA_HAS_MSA)
#define HAVE_reduc_plus_scal_v2di (ISA_HAS_MSA)
#define HAVE_reduc_plus_scal_v4si (ISA_HAS_MSA)
#define HAVE_reduc_plus_scal_v8hi (ISA_HAS_MSA)
#define HAVE_reduc_plus_scal_v16qi (ISA_HAS_MSA)
#define HAVE_reduc_and_scal_v2di (ISA_HAS_MSA)
#define HAVE_reduc_ior_scal_v2di (ISA_HAS_MSA)
#define HAVE_reduc_xor_scal_v2di (ISA_HAS_MSA)
#define HAVE_reduc_and_scal_v4si (ISA_HAS_MSA)
#define HAVE_reduc_ior_scal_v4si (ISA_HAS_MSA)
#define HAVE_reduc_xor_scal_v4si (ISA_HAS_MSA)
#define HAVE_reduc_and_scal_v8hi (ISA_HAS_MSA)
#define HAVE_reduc_ior_scal_v8hi (ISA_HAS_MSA)
#define HAVE_reduc_xor_scal_v8hi (ISA_HAS_MSA)
#define HAVE_reduc_and_scal_v16qi (ISA_HAS_MSA)
#define HAVE_reduc_ior_scal_v16qi (ISA_HAS_MSA)
#define HAVE_reduc_xor_scal_v16qi (ISA_HAS_MSA)
...
extern rtx        gen_sunordered_sf_using_cce         (rtx, rtx, rtx);
extern rtx        gen_suneq_sf_using_cce              (rtx, rtx, rtx);
extern rtx        gen_sunlt_sf_using_cce              (rtx, rtx, rtx);
extern rtx        gen_sunle_sf_using_cce              (rtx, rtx, rtx);
extern rtx        gen_seq_sf_using_cce                (rtx, rtx, rtx);
extern rtx        gen_slt_sf_using_cce                (rtx, rtx, rtx);
extern rtx        gen_sle_sf_using_cce                (rtx, rtx, rtx);
static inline rtx gen_sordered_sf_using_cce           (rtx, rtx, rtx);
static inline rtx
gen_sordered_sf_using_cce(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_sltgt_sf_using_cce              (rtx, rtx, rtx);
static inline rtx
gen_sltgt_sf_using_cce(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_sne_sf_using_cce                (rtx, rtx, rtx);
static inline rtx
gen_sne_sf_using_cce(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_sunordered_df_using_cce         (rtx, rtx, rtx);
extern rtx        gen_suneq_df_using_cce              (rtx, rtx, rtx);
extern rtx        gen_sunlt_df_using_cce              (rtx, rtx, rtx);
extern rtx        gen_sunle_df_using_cce              (rtx, rtx, rtx);
extern rtx        gen_seq_df_using_cce                (rtx, rtx, rtx);
extern rtx        gen_slt_df_using_cce                (rtx, rtx, rtx);
extern rtx        gen_sle_df_using_cce                (rtx, rtx, rtx);
static inline rtx gen_sordered_df_using_cce           (rtx, rtx, rtx);
static inline rtx
gen_sordered_df_using_cce(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_sltgt_df_using_cce              (rtx, rtx, rtx);
static inline rtx
gen_sltgt_df_using_cce(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_sne_df_using_cce                (rtx, rtx, rtx);
static inline rtx
gen_sne_df_using_cce(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
extern rtx        gen_sge_sf_using_cce                (rtx, rtx, rtx);
extern rtx        gen_sgt_sf_using_cce                (rtx, rtx, rtx);
extern rtx        gen_sunge_sf_using_cce              (rtx, rtx, rtx);
extern rtx        gen_sungt_sf_using_cce              (rtx, rtx, rtx);
extern rtx        gen_sge_df_using_cce                (rtx, rtx, rtx);
extern rtx        gen_sgt_df_using_cce                (rtx, rtx, rtx);
extern rtx        gen_sunge_df_using_cce              (rtx, rtx, rtx);
extern rtx        gen_sungt_df_using_cce              (rtx, rtx, rtx);
...
extern rtx        gen_movsi_on_si                     (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_movdi_on_si                     (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_movsi_on_di                     (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_movdi_on_di                     (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_movsi_on_cc                     (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_movdi_on_cc                     (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_movsi_on_cce                    (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_movdi_on_cce                    (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_movsi_on_si_mips16e2            (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_movdi_on_si_mips16e2            (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_movsi_on_di_mips16e2            (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_movdi_on_di_mips16e2            (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_movsi_on_cc_mips16e2            (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_movdi_on_cc_mips16e2            (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_movsi_on_cce_mips16e2           (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_movdi_on_cce_mips16e2           (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_movsi_on_si_ne                  (rtx, rtx, rtx, rtx);
extern rtx        gen_movdi_on_si_ne                  (rtx, rtx, rtx, rtx);
extern rtx        gen_movsi_on_di_ne                  (rtx, rtx, rtx, rtx);
extern rtx        gen_movdi_on_di_ne                  (rtx, rtx, rtx, rtx);
extern rtx        gen_movsi_on_si_ne_mips16e2         (rtx, rtx, rtx, rtx);
extern rtx        gen_movdi_on_si_ne_mips16e2         (rtx, rtx, rtx, rtx);
extern rtx        gen_movsi_on_di_ne_mips16e2         (rtx, rtx, rtx, rtx);
extern rtx        gen_movdi_on_di_ne_mips16e2         (rtx, rtx, rtx, rtx);
...
extern rtx        gen_fmin_a_sf                       (rtx, rtx, rtx);
extern rtx        gen_fmin_a_df                       (rtx, rtx, rtx);
extern rtx        gen_fmax_a_sf                       (rtx, rtx, rtx);
extern rtx        gen_fmax_a_df                       (rtx, rtx, rtx);
extern rtx        gen_rintsf2                         (rtx, rtx);
extern rtx        gen_rintdf2                         (rtx, rtx);
extern rtx        gen_fclass_sf                       (rtx, rtx);
extern rtx        gen_fclass_df                       (rtx, rtx);
...
extern rtx        gen_msa_shf_d_f                     (rtx, rtx, rtx);
...
extern rtx        gen_sdot_prodv2siv4hi               (rtx, rtx, rtx, rtx);
...
extern rtx        gen_vcond_mask_v2dfv4si             (rtx, rtx, rtx, rtx);
extern rtx        gen_vcond_mask_v2dfv8hi             (rtx, rtx, rtx, rtx);
extern rtx        gen_vcond_mask_v2dfv16qi            (rtx, rtx, rtx, rtx);
extern rtx        gen_vcond_mask_v4sfv2di             (rtx, rtx, rtx, rtx);
extern rtx        gen_vcond_mask_v4sfv4si             (rtx, rtx, rtx, rtx);
extern rtx        gen_vcond_mask_v4sfv8hi             (rtx, rtx, rtx, rtx);
extern rtx        gen_vcond_mask_v4sfv16qi            (rtx, rtx, rtx, rtx);
extern rtx        gen_vcond_mask_v2div2di             (rtx, rtx, rtx, rtx);
extern rtx        gen_vcond_mask_v2div4si             (rtx, rtx, rtx, rtx);
extern rtx        gen_vcond_mask_v2div8hi             (rtx, rtx, rtx, rtx);
extern rtx        gen_vcond_mask_v2div16qi            (rtx, rtx, rtx, rtx);
extern rtx        gen_vcond_mask_v4siv2di             (rtx, rtx, rtx, rtx);
extern rtx        gen_vcond_mask_v4siv4si             (rtx, rtx, rtx, rtx);
extern rtx        gen_vcond_mask_v4siv8hi             (rtx, rtx, rtx, rtx);
extern rtx        gen_vcond_mask_v4siv16qi            (rtx, rtx, rtx, rtx);
extern rtx        gen_vcond_mask_v8hiv2di             (rtx, rtx, rtx, rtx);
extern rtx        gen_vcond_mask_v8hiv4si             (rtx, rtx, rtx, rtx);
extern rtx        gen_vcond_mask_v8hiv8hi             (rtx, rtx, rtx, rtx);
extern rtx        gen_vcond_mask_v8hiv16qi            (rtx, rtx, rtx, rtx);
extern rtx        gen_vcond_mask_v16qiv2di            (rtx, rtx, rtx, rtx);
extern rtx        gen_vcond_mask_v16qiv4si            (rtx, rtx, rtx, rtx);
extern rtx        gen_vcond_mask_v16qiv8hi            (rtx, rtx, rtx, rtx);
...
extern rtx        gen_reduc_umin_scal_v2di            (rtx, rtx);
...
extern rtx        gen_reduc_umax_scal_v2di            (rtx, rtx);
