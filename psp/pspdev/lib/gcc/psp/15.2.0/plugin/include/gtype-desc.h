...
#define gt_ggc_m_33hash_map_nofree_string_hash_bool_(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_hash_map_nofree_string_hash_bool_ (X);\
  } while (0)
extern void gt_ggc_mx_hash_map_nofree_string_hash_bool_ (void *);
#define gt_ggc_m_32hash_map_nofree_string_hash_rtx_(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_hash_map_nofree_string_hash_rtx_ (X);\
  } while (0)
extern void gt_ggc_mx_hash_map_nofree_string_hash_rtx_ (void *);
...
#define gt_pch_n_33hash_map_nofree_string_hash_bool_(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_hash_map_nofree_string_hash_bool_ (X);\
  } while (0)
extern void gt_pch_nx_hash_map_nofree_string_hash_bool_ (void *);
#define gt_pch_n_32hash_map_nofree_string_hash_rtx_(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_hash_map_nofree_string_hash_rtx_ (X);\
  } while (0)
extern void gt_pch_nx_hash_map_nofree_string_hash_rtx_ (void *);
...
extern void gt_pch_p_20ssa_operand_memory_d
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_33hash_map_nofree_string_hash_bool_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_32hash_map_nofree_string_hash_rtx_
    (void *, void *, gt_pointer_operator, void *);
