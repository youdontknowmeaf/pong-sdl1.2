...
enum opt_code
{
  ...
  OPT_list = 2041,                           /* -list */
  OPT_mabi_ = 2042,                          /* -mabi= */
  OPT_mabicalls = 2043,                      /* -mabicalls */
  OPT_mabs_ = 2044,                          /* -mabs= */
  OPT_main = 2045,                           /* -main */
  OPT_main_ = 2046,                          /* -main= */
  OPT_march_ = 2047,                         /* -march= */
  OPT_mbranch_cost_ = 2048,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 2049,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 2050,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 2051,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 2052,             /* -mcompact-branches= */
  OPT_mcrc = 2053,                           /* -mcrc */
  OPT_mdebug = 2054,                         /* -mdebug */
  OPT_mdebugd = 2055,                        /* -mdebugd */
  OPT_mdivide_breaks = 2056,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 2057,                  /* -mdivide-traps */
  OPT_mdmx = 2058,                           /* -mdmx */
  OPT_mdouble_float = 2059,                  /* -mdouble-float */
  OPT_mdsp = 2060,                           /* -mdsp */
  OPT_mdspr2 = 2061,                         /* -mdspr2 */
  OPT_meb = 2062,                            /* -meb */
  OPT_mel = 2063,                            /* -mel */
  OPT_membedded_data = 2064,                 /* -membedded-data */
  OPT_meva = 2065,                           /* -meva */
  /* OPT_mexplicit_relocs = 2066, */         /* -mexplicit-relocs */
  OPT_mexplicit_relocs_ = 2067,              /* -mexplicit-relocs= */
  OPT_mextern_sdata = 2068,                  /* -mextern-sdata */
  OPT_mfix_24k = 2069,                       /* -mfix-24k */
  OPT_mfix_r10000 = 2070,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 2071,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 2072,                     /* -mfix-r4400 */
  OPT_mfix_r5900 = 2073,                     /* -mfix-r5900 */
  OPT_mfix_rm7000 = 2074,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 2075,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 2076,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 2077,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 2078,                       /* -mfix4300 */
  OPT_mflip_mips16 = 2079,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 2080,                   /* -mflush-func= */
  OPT_mfp_exceptions = 2081,                 /* -mfp-exceptions */
  OPT_mfp32 = 2082,                          /* -mfp32 */
  OPT_mfp64 = 2083,                          /* -mfp64 */
  OPT_mfpxx = 2084,                          /* -mfpxx */
  OPT_mframe_header_opt = 2085,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 2086, */              /* -mfused-madd */
  OPT_mginv = 2087,                          /* -mginv */
  OPT_mgp32 = 2088,                          /* -mgp32 */
  OPT_mgp64 = 2089,                          /* -mgp64 */
  OPT_mgpopt = 2090,                         /* -mgpopt */
  OPT_mhard_float = 2091,                    /* -mhard-float */
  OPT_mimadd = 2092,                         /* -mimadd */
  OPT_minterlink_compressed = 2093,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 2094,              /* -minterlink-mips16 */
  OPT_mips = 2095,                           /* -mips */
  OPT_mips16 = 2096,                         /* -mips16 */
  OPT_mips3d = 2097,                         /* -mips3d */
  OPT_mllsc = 2098,                          /* -mllsc */
  OPT_mload_store_pairs = 2099,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 2100,                   /* -mlocal-sdata */
  OPT_mlong_calls = 2101,                    /* -mlong-calls */
  OPT_mlong32 = 2102,                        /* -mlong32 */
  OPT_mlong64 = 2103,                        /* -mlong64 */
  OPT_mloongson_ext = 2104,                  /* -mloongson-ext */
  OPT_mloongson_ext2 = 2105,                 /* -mloongson-ext2 */
  OPT_mloongson_mmi = 2106,                  /* -mloongson-mmi */
  OPT_mlxc1_sxc1 = 2107,                     /* -mlxc1-sxc1 */
  OPT_mmad = 2108,                           /* -mmad */
  OPT_mmadd4 = 2109,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 2110,             /* -mmcount-ra-address */
  OPT_mmcu = 2111,                           /* -mmcu */
  OPT_mmemcpy = 2112,                        /* -mmemcpy */
  OPT_mmicromips = 2113,                     /* -mmicromips */
  OPT_mmips16e2 = 2114,                      /* -mmips16e2 */
  OPT_mmsa = 2115,                           /* -mmsa */
  OPT_mmt = 2116,                            /* -mmt */
  OPT_mnan_ = 2117,                          /* -mnan= */
  /* OPT_mno_explicit_relocs = 2118, */      /* -mno-explicit-relocs */
  OPT_mno_float = 2119,                      /* -mno-float */
  OPT_mno_flush_func = 2120,                 /* -mno-flush-func */
  OPT_mno_mdmx = 2121,                       /* -mno-mdmx */
  OPT_mno_mips16 = 2122,                     /* -mno-mips16 */
  OPT_mno_mips3d = 2123,                     /* -mno-mips3d */
  /* OPT_mno_unaligned_access = 2124, */     /* -mno-unaligned-access */
  OPT_modd_spreg = 2125,                     /* -modd-spreg */
  OPT_mpaired_single = 2126,                 /* -mpaired-single */
  OPT_mplt = 2127,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 2128,     /* -mpreferred-stack-boundary= */
  OPT_mr10k_cache_barrier_ = 2129,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 2130,               /* -mrelax-pic-calls */
  OPT_mshared = 2131,                        /* -mshared */
  OPT_msingle_float = 2132,                  /* -msingle-float */
  OPT_msmartmips = 2133,                     /* -msmartmips */
  OPT_msoft_float = 2134,                    /* -msoft-float */
  OPT_msplit_addresses = 2135,               /* -msplit-addresses */
  OPT_mstrict_align = 2136,                  /* -mstrict-align */
  OPT_msym32 = 2137,                         /* -msym32 */
  OPT_msynci = 2138,                         /* -msynci */
  OPT_mtune_ = 2139,                         /* -mtune= */
  /* OPT_munaligned_access = 2140, */        /* -munaligned-access */
  OPT_muninit_const_in_rodata = 2141,        /* -muninit-const-in-rodata */
  OPT_mvirt = 2142,                          /* -mvirt */
  OPT_mvr4130_align = 2143,                  /* -mvr4130-align */
  OPT_mxgot = 2144,                          /* -mxgot */
  OPT_mxpa = 2145,                           /* -mxpa */
  OPT_n = 2146,                              /* -n */
  OPT_name_sort = 2147,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2148,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2149,              /* -no-integrated-cpp */
  OPT_no_pie = 2150,                         /* -no-pie */
  OPT_noasmopt = 2151,                       /* -noasmopt */
  OPT_nocpp = 2152,                          /* -nocpp */
  OPT_nodefaultlibs = 2153,                  /* -nodefaultlibs */
  OPT_nolibc = 2154,                         /* -nolibc */
  OPT_nomain = 2155,                         /* -nomain */
  OPT_nophoboslib = 2156,                    /* -nophoboslib */
  OPT_nostartfiles = 2157,                   /* -nostartfiles */
  OPT_nostdinc = 2158,                       /* -nostdinc */
  OPT_nostdinc__ = 2159,                     /* -nostdinc++ */
  OPT_nostdlib = 2160,                       /* -nostdlib */
  OPT_nostdlib__ = 2161,                     /* -nostdlib++ */
  OPT_o = 2162,                              /* -o */
  OPT_objects = 2163,                        /* -objects */
  OPT_p = 2164,                              /* -p */
  OPT_pass_exit_codes = 2165,                /* -pass-exit-codes */
  /* OPT_pedantic = 2166, */                 /* -pedantic */
  OPT_pedantic_errors = 2167,                /* -pedantic-errors */
  OPT_pg = 2168,                             /* -pg */
  OPT_pie = 2169,                            /* -pie */
  OPT_pipe = 2170,                           /* -pipe */
  OPT_preprocess = 2171,                     /* -preprocess */
  OPT_print_file_name_ = 2172,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2173,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2174,          /* -print-multi-directory */
  OPT_print_multi_lib = 2175,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2176,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2177,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2178,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2179,               /* -print-prog-name= */
  OPT_print_search_dirs = 2180,              /* -print-search-dirs */
  OPT_print_sysroot = 2181,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2182,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2183,                    /* -print-value */
  OPT_quiet = 2184,                          /* -quiet */
  OPT_r = 2185,                              /* -r */
  OPT_remap = 2186,                          /* -remap */
  OPT_reverse_sort = 2187,                   /* -reverse-sort */
  OPT_s = 2188,                              /* -s */
  OPT_save_temps = 2189,                     /* -save-temps */
  OPT_save_temps_ = 2190,                    /* -save-temps= */
  OPT_shared = 2191,                         /* -shared */
  OPT_shared_libgcc = 2192,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2193,               /* -shared-libphobos */
  OPT_size_sort = 2194,                      /* -size-sort */
  /* OPT_specs = 2195, */                    /* -specs */
  OPT_specs_ = 2196,                         /* -specs= */
  OPT_static = 2197,                         /* -static */
  OPT_static_libasan = 2198,                 /* -static-libasan */
  OPT_static_libgcc = 2199,                  /* -static-libgcc */
  OPT_static_libgcobol = 2200,               /* -static-libgcobol */
  OPT_static_libgfortran = 2201,             /* -static-libgfortran */
  OPT_static_libgm2 = 2202,                  /* -static-libgm2 */
  OPT_static_libgo = 2203,                   /* -static-libgo */
  OPT_static_libhwasan = 2204,               /* -static-libhwasan */
  OPT_static_liblsan = 2205,                 /* -static-liblsan */
  OPT_static_libmpx = 2206,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2207,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2208,               /* -static-libphobos */
  OPT_static_libquadmath = 2209,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2210,               /* -static-libstdc++ */
  OPT_static_libtsan = 2211,                 /* -static-libtsan */
  OPT_static_libubsan = 2212,                /* -static-libubsan */
  OPT_static_pie = 2213,                     /* -static-pie */
  /* OPT_std_c__03 = 2214, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2215, */                /* -std=c++0x */
  OPT_std_c__11 = 2216,                      /* -std=c++11 */
  OPT_std_c__14 = 2217,                      /* -std=c++14 */
  OPT_std_c__17 = 2218,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2219, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2220, */                /* -std=c++1z */
  OPT_std_c__20 = 2221,                      /* -std=c++20 */
  OPT_std_c__23 = 2222,                      /* -std=c++23 */
  OPT_std_c__26 = 2223,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2224, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2225, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2226, */                /* -std=c++2c */
  OPT_std_c__98 = 2227,                      /* -std=c++98 */
  OPT_std_c11 = 2228,                        /* -std=c11 */
  OPT_std_c17 = 2229,                        /* -std=c17 */
  /* OPT_std_c18 = 2230, */                  /* -std=c18 */
  /* OPT_std_c1x = 2231, */                  /* -std=c1x */
  OPT_std_c23 = 2232,                        /* -std=c23 */
  /* OPT_std_c2x = 2233, */                  /* -std=c2x */
  OPT_std_c2y = 2234,                        /* -std=c2y */
  /* OPT_std_c89 = 2235, */                  /* -std=c89 */
  OPT_std_c90 = 2236,                        /* -std=c90 */
  OPT_std_c99 = 2237,                        /* -std=c99 */
  /* OPT_std_c9x = 2238, */                  /* -std=c9x */
  OPT_std_f2003 = 2239,                      /* -std=f2003 */
  OPT_std_f2008 = 2240,                      /* -std=f2008 */
  OPT_std_f2008ts = 2241,                    /* -std=f2008ts */
  OPT_std_f2018 = 2242,                      /* -std=f2018 */
  OPT_std_f2023 = 2243,                      /* -std=f2023 */
  OPT_std_f202y = 2244,                      /* -std=f202y */
  OPT_std_f95 = 2245,                        /* -std=f95 */
  OPT_std_gnu = 2246,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2247, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2248, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2249,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2250,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2251,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2252, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2253, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2254,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2255,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2256,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2257, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2258, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2259, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2260,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2261,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2262,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2263, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2264, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2265,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2266, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2267,                      /* -std=gnu2y */
  /* OPT_std_gnu89 = 2268, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2269,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2270,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2271, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2272, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2273,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2274, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2275, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2276, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2277, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2278, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2279, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2280,                     /* -std=legacy */
  OPT_stdlib_ = 2281,                        /* -stdlib= */
  OPT_symbol_ = 2282,                        /* -symbol= */
  OPT_symbolic = 2283,                       /* -symbolic */
  OPT_t = 2284,                              /* -t */
  OPT_time = 2285,                           /* -time */
  OPT_time_ = 2286,                          /* -time= */
  OPT_traditional = 2287,                    /* -traditional */
  OPT_traditional_cpp = 2288,                /* -traditional-cpp */
  OPT_tree_stats = 2289,                     /* -tree-stats */
  OPT_trigraphs = 2290,                      /* -trigraphs */
  OPT_truncate = 2291,                       /* -truncate */
  OPT_type_stats = 2292,                     /* -type-stats */
  OPT_u = 2293,                              /* -u */
  OPT_undef = 2294,                          /* -undef */
  OPT_v = 2295,                              /* -v */
  OPT_version = 2296,                        /* -version */
  OPT_w = 2297,                              /* -w */
  OPT_wrapper = 2298,                        /* -wrapper */
  OPT_x = 2299,                              /* -x */
  OPT_z = 2300,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
